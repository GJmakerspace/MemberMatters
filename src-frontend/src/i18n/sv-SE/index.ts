...
export default {
  menuLink: {
    ...
    interlockReservations: 'Interlock-bokningar',
  ...
  interlockReservations: {
    title: 'Interlock-bokningar',
    description: 'Se verktygsbokningar och reservera en tid som passar dig.',
    calendarHint:
      'Tiderna nedan gäller det valda datumet. Använd kalendern för att hoppa till en annan dag.',
    newReservation: 'Boka tid',
    unassignedReservation: 'Bokad',
    noInterlocks: 'Du har inte tillgång till några interlocks med bokning.',
    noReservationsForDay: 'Inga bokningar denna dag.',
    createTitle: 'Boka {name}',
    startTime: 'Starttid',
    endTime: 'Sluttid',
    saveReservation: 'Spara bokning',
    invalidDate: 'Välj en giltig start- och sluttid.',
    startAfterEnd: 'Sluttiden måste vara efter starttiden.',
    reservationConflict: 'Tiden överlappar en annan bokning.',
    cancelTitle: 'Avbryt bokning',
    cancelMessage:
      'Avbryt bokningen? Tidsluckan blir direkt tillgänglig för andra.',
    cancelReason: 'Anledning (valfri)',
  },
  lastseen: {
    pageDescription:
